...
def main(args):
    ...
    doc_query_dump = [documents, queries]
    import pickle
    print("Dumping the data input to the negatives generation function at : data_neg_output/negativesout.pickle ")
    with open("data_neg_output/negativesout.pickle", "wb") as dataset_file:
        pickle.dump(doc_query_dump, dataset_file)
